...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MIN_POS    -5        // A min coordinate so the X2 carriage can't hit the parked X1 carriage
  #define X2_MAX_POS   (373+X1_MIN_POS)      // The max position of the X2 carriage, typically also the home position
  ...
  // Pin assignemnts for X2 stepper
