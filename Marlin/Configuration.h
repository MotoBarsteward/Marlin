...
#define CUSTOM_MACHINE_NAME "Zaphod Prusa"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
//#define MACHINE_UUID "2442512d-28b3-49eb-a6a1-10ccd2a9f6a8"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  38.66,  64.77 }
    #define DEFAULT_Ki_LIST {   4.21,   5.88 }
    #define DEFAULT_Kd_LIST {  88.67,  85.36 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 64.77
  #define DEFAULT_bedKi 3.39
  #define DEFAULT_bedKd 824.23
...
#define J_MIN_ENDSTOP_INVERTING fasle // Set to true to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 3200/(16*2.5), 3200/(8*5), 3200.0/1.25, 499.1, 499.1 }
